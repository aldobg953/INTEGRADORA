    ...
    const sections = [
        {
            fields: [
                ...
                { id: "message", errorId: "messageErrorV", minLength: 15, maxLength: 599, required: true },
                { id: "direccion", errorId: "direccionErrorV", minLength: 8, maxLength: 250, required: true },
                { id: "direccionGoogle", errorId: "direccionGoogleErrorV", minLength: 8, maxLength: 600, required: true  },
                { id: "tipo_institucion", errorId: "tipoErrorV", minLength: 4, maxLength: 50, required: true  },
